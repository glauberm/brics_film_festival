...
class Brics_Incubator_Meeting_Enrollment_Form extends Brics_Abstract_Enrollment_Form {
	protected $route   = 'incubator_meeting_enrollment_form';
	protected $email   = 'incubator-meeting-enrollment-form';
	protected $subject = 'Inscrição no Encontro da Incubadora';
