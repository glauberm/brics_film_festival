...
class PreservationMeetingEnrollmentForm extends PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      recaptcha: null
    ...
    return (
      <React.Fragment>
        ...
        <form name='contact' method='POST' action={this.props.formAction}>
          ...
          <FormControl>
            <label>
              <span>Breve descrição de sua atuação ou interesse no campo da preservação audiovisual</span>
